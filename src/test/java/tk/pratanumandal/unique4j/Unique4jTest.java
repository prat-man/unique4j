...
public class Unique4jTest {
	...
	@Test
	public void testCustomAddress() throws Unique4jException, UnknownHostException {
		...
		Unique4j unique1 = new Unique4j(APP_ID, false, InetAddress.getByName("0.0.0.0"), Unique4j.DYNAMIC_PORT) {
			@Override
			protected String sendMessage() {
				// send null
				return null;
		...
		Unique4j unique2 = new Unique4j(APP_ID, false, InetAddress.getByName("0.0.0.0"), Unique4j.DYNAMIC_PORT) {
			@Override
			protected String sendMessage() {
				// send message
				return message;
	...
	@Test
	public void testCustomPort() throws Unique4jException, UnknownHostException {
		...
		Unique4j unique1 = new Unique4j(APP_ID, false, Unique4j.DEFAULT_ADDRESS, 8080) {
			@Override
			protected String sendMessage() {
				// send null
				return null;
		...
		Unique4j unique2 = new Unique4j(APP_ID, false, Unique4j.DEFAULT_ADDRESS, 8080) {
			@Override
			protected String sendMessage() {
				// send message
				return message;
	...
	@Test
	public void testCustomAddressAndPort() throws Unique4jException, UnknownHostException {
		...
		Unique4j unique1 = new Unique4j(APP_ID, false, InetAddress.getByName("0.0.0.0"), 8080) {
			@Override
			protected String sendMessage() {
				// send null
				return null;
		...
		Unique4j unique2 = new Unique4j(APP_ID, false, InetAddress.getByName("0.0.0.0"), 8080) {
			@Override
			protected String sendMessage() {
				// send message
				return message;
