...
/**
 * The <code>Unique4jList</code> class is a logical entry point to the library which extends the functionality of the <code>Unique4j</code> class.<br>
...
public abstract class Unique4jList extends Unique4j {
	 ...
	 */
	public Unique4jList(String APP_ID, int PORT, PortPolicy PORT_POLICY) {
	 ...
	 * @param PORT_POLICY Port policy to use - STATIC or DYNAMIC
	 */
	public Unique4jList(String APP_ID, boolean AUTO_EXIT, int PORT, PortPolicy PORT_POLICY) {
